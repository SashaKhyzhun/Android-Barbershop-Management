...
import com.sashakhyzhun.androidbarbershopmanagementprototype.R.color.event_color_01
import com.alamkanak.weekview.WeekViewEvent
import com.sashakhyzhun.androidbarbershopmanagementprototype.R
import com.sashakhyzhun.androidbarbershopmanagementprototype.utils.getEventTitle
import java.util.*
 ...
 * Created on 9/13/18.
 */
class BasicActivity : DailyActivity() {
...
//        event = WeekViewEvent(8, "", 0, startTime, endTime, 0)
//        event.color = resources.getColor(R.color.event_color_03)
//        events.add(event)
//
